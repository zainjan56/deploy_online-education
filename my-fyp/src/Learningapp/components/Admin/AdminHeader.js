    ...
    >
      ...
      <Container>
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          ...
          <Navbar.Brand>Welcome To Admin Portion</Navbar.Brand>
          </Nav>
          <Nav>
          <Dropdown className="d-inline mx-2" autoClose="inside">
              ...
              <Dropdown.Menu style={{ minWidth: "100%" }}>
                <Dropdown.Item><Link exact to="/adminprofile" className="profile-link">Profile</Link></Dropdown.Item>
                <Dropdown.Item><Link exact to="/adminstudentrec" className="profile-link">Student Records</Link></Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
          </Nav>
        </Navbar.Collapse>
