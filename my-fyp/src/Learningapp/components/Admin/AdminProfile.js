            ...
            <MDBCard className="mb-4">
              <MDBCardBody className="text-center">
                ...
                <div className="justify-content-center">
                  <Link to='/adminprofilechange'><button className='btn btn-primary'>Edit</button></Link>
                  <Link to='/adminpasswordchange'><button className="btn btn-primary ms-1">Change Password</button></Link>
                </div>
              </MDBCardBody>
            </MDBCard>
          </MDBCol>
