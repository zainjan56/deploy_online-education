            ...
            <MDBCard className="mb-4">
              <MDBCardBody className="text-center">
                ...
                <div className="justify-content-center">
                  <Link to='/profilechange'><button className='btn btn-primary'>Edit</button></Link>
                  <Link to='/changepassword'><button className="btn btn-primary ms-1">Change Password</button></Link>
                </div>
              </MDBCardBody>
            </MDBCard>
          </MDBCol>
